...
const FloatingCosmos = () => {
  const flowers = [
    { size: 44, x: "8%", y: "12%", delay: 0, color: "#ffd6e0" },
    { size: 30, x: "88%", y: "8%", delay: 0.8, color: "#c9e8f5" },
    { size: 36, x: "5%", y: "55%", delay: 1.4, color: "#d7f2e4" },
    { size: 26, x: "93%", y: "42%", delay: 0.4, color: "#e7d9ff" },
    { size: 34, x: "82%", y: "78%", delay: 1.1, color: "#ffe4c7" },
    { size: 28, x: "15%", y: "88%", delay: 1.9, color: "#bfe7ff" },
    { size: 40, x: "50%", y: "5%", delay: 0.6, color: "#d8f0ff" },
  ];
      ...
      <div className="relative z-10 max-w-md mx-auto px-5 pb-24">
          ...
          >
            {stepIndex === 0 && (
              ...
              >
                ...
                >
                  No pressure. Just a decent evening, some good food,
                ...
                <motion.div
                  className="mt-14 text-sky-400/60"
                  animate={{ y: [0, 6, 0] }}
        ...
        <div className="mt-8 flex items-center justify-between">
          <button
            ...
            className="px-3 py-1.5 text-[10px] font-semibold tracking-widest uppercase rounded-full border border-sky-200/60 text-sky-600 bg-white/40 backdrop-blur-sm disabled:opacity-40 disabled:cursor-not-allowed"
          >
            Prev
          </button>
